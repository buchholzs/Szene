...
int GRXMain(int argc, char *argv[])
{
	 ...
	 desktopargs.desktop_w = 800;
	 desktopargs.desktop_h = 600;
...
//   editargs.editarea.textarea.endtest = MxLineEndCharwrap;
	 edit = MxScrollEditareaNew(0, 15, 30, 250, 150, &editargs);

	 /* Make a window to put the editarea in as client */
	 MxArgsInit(&winargs);
	 winargs.caption = "MxEditarea";
	 winargs.client = &edit->base.object;
	 MxWindowNew(&desktop.base.object, 15, 30, 250, 150, &winargs);
